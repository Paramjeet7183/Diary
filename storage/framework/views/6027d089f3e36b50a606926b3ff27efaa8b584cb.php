...
<div class="container ">
<form action="saveprivate" method="post" class="center1">
<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?></span>
            ...
            <p>
            <h6><b><span class="text-danger"><?php $__errorArgs = ['story'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></span></b></h6>
            <div class="mb-3">
      ...
      style="border:none;height:20vh;"></textarea>
      
   </div>
            </p>
            <div class="d-flex mybox">
            <button class="b1 disabled">Created at:NOW</button>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wdiary-app\resources\views/addprivate.blade.php ENDPATH**/ ?>