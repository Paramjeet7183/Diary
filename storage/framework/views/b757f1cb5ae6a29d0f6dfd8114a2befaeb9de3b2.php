            ...
            <div class="container-fluid hero ">
                <div class="row d-flex flex-wrap ">
                    ...
                    <div class="my-col2 col-lg-5 col-md-5 bg-white d-flex flex-column">
                        ...
                        <div class=" btn-cont">
                        <a href="<?php echo e(route('register')); ?>"> <button type="button" class="btn btn-warning btn-lg font-weight-bold">Get Started</button></a>
                ...
                <div class="row" id="diary-feature">
                    ...
                    <a href="<?php echo e(url('/public')); ?>"> <button type="button" class="btn btn-primary btn-lg">Visit</button></a>
                    </div>
                    ...
                    <a href="<?php echo e(url('/private')); ?>"> <button type="button" class="btn btn-warning btn-lg">Private Diary</button></a>
                    </div>
                 ...
                 <div class="row">
                    ...
                    <a href="<?php echo e(url('/contact')); ?>"> <button type="button" class="btn btn-dark btn-lg">Contact-Us</button></div></a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wdiary-app\resources\views/welcome.blade.php ENDPATH**/ ?>