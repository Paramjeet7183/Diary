...
unset($__errorArgs, $__bag); ?></span></b></h6>
      ...
      style="border:none;height:20vh;"> <?php echo e($data['story']); ?></textarea>
      
   </div>
            </p>
            <div class="d-flex mybox">
            <button class="b1 disabled"><?php echo e($data['created_at']); ?></button>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wdiary-app\resources\views/editprivate.blade.php ENDPATH**/ ?>