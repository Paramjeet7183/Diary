    ...
    <div class="row">
        <div class="my-col2 col-lg-12 col-md-12 col-sm-12 bg-white d-flex">
            ...
            <div class="col-lg-6 col-md-9 ">
                ...
                <a href="<?php echo e(url('/add-diary')); ?>"> <button type="button" class="btn btn-primary btn-lg font-weight-bold m-3 ">Create Diary</button></a>
            </div>
        </div>
        <div class="my-col1 col-lg-4 col-md-4 col-sm-12 bg-light">...</div>
        <div class="my-col3 col-lg-4 col-md-4 col-sm-12 bg-light">...</div>
        <div class="my-col4 col-lg-4 col-md-4 col-sm-12 bg-dark d-flex"> <a href="<?php echo e(url('/showpublic')); ?>"> <button type="button" class="btn btn-primary btn-lg font-weight-bold m-3 ">View All Public Posts</button></a></div>
    </div>
    <main>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wdiary-app\resources\views/public.blade.php ENDPATH**/ ?>