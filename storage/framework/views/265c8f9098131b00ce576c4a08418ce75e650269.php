        ...
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm  text-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                                    <a class="nav-link hov text-light" href="<?php echo e(url('/')); ?>"><h6><b>Home</b></h6></a>
                                </li>
                    <li class="nav-item">
                                    <a class="nav-link hov text-light" href="<?php echo e(url('/public')); ?>"><h6><b>Public Diary</b></h6></a>
                                </li>
                    <li class="nav-item">
                                    <a class="nav-link hov text-light" href="<?php echo e(url('/private')); ?>"><h6><b>Private Diary</b></h6></a>
                                </li>
                    <li class="nav-item">
                                    <a class="nav-link hov text-light" href="<?php echo e(url('/contact')); ?>"><h6><b>Contact</b></h6></a>
                                </li>
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link login text-white" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                                </li>
                            <?php endif; ?>
                            
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link register text-white" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\wdiary-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>